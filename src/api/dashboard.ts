...
export const getTotalWallet = async () => {
  return axiosInstance.get('/taix/dashboard/getTotalWallet');
};
...
export const getTotalUser = async () => {
  return axiosInstance.get('/taix/dashboard/getTotalUser');
};
...
export const getTotalUserDaily = async () => {
  return axiosInstance.get('/taix/dashboard/getTotalUserDaily');
};
...
export const getTotalLabel = async () => {
  return axiosInstance.get('/taix/dashboard/getTotalLabel');
};
...
export const getTotalAsset = async () => {
  return axiosInstance.get('/taix/dashboard/getTotalAsset');
};
...
export const getTop20RankingUser = async () => {
  return axiosInstance.get('/taix/dashboard/getTop20RankingUser');
};
...
export const getPointsDistribution = async () => {
  return axiosInstance.get('/taix/dashboard/getPointsDistribution');
};

// POST
// /api/taix/dashboard/getAssetScale
// 获取今天以前7天的全部用户的净资产
export const getAssetScale = async (data: any) => {
  return axiosInstance.post('/taix/dashboard/getAssetScale', data);
};
